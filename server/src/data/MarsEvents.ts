...
const _marsEvents: Array<MarsEventData> = [
  ...
  },
  {
    ...
    clientViewHandler: "DRAW_RESOURCE" as const,
    duration: 1,
  },
  {
    id: "breakdownOfTrust",
    ...
    clientViewHandler: "SELECT_RESOURCE" as const,
    duration: 1,
  },
  {
    id: "changingTides",
  ...
  },
  {
    ...
    clientViewHandler: "SELECT_PURCHASED_ACCOMPLISHMENT" as const,
    duration: 1,
  },
  {
    id: "heroOrPariah",
    ...
    clientViewHandler: "VOTE_HERO_PARIAH" as const,
    duration: 1,
  },
  {
    id: "hullBreach",
...
export function getMarsEventDeckItems(): Array<MarsEventDeckItem> {
  ...
  for (const [eventId, numberOfCopies] of AVAILABLE_EVENTS) {
    const marsEventData = _.find(
      _marsEvents,
      (ev: MarsEventData) => ev.id === eventId
    );
    if (marsEventData) {
      availableEvents.push(
        _.cloneDeep({ event: marsEventData, numberOfCopies: numberOfCopies })
      );
    } else {
