...
export class AddLiteGame1745442643206 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`CREATE TABLE "lite_player_decision" ("id" SERIAL NOT NULL, "systemHealthInvestment" integer NOT NULL, "pointsInvestment" integer NOT NULL, "roundId" integer NOT NULL, "playerId" integer NOT NULL, CONSTRAINT "PK_8e7489a1768b0c610fa8427a02d" PRIMARY KEY ("id"))`);
        ...
        await queryRunner.query(`CREATE TABLE "lite_game_round" ("id" SERIAL NOT NULL, "dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "roundNumber" integer NOT NULL, "initialSystemHealth" integer NOT NULL, "initialPoints" integer NOT NULL, "gameId" integer NOT NULL, CONSTRAINT "PK_86c22a476b05fe4507eb7ae0953" PRIMARY KEY ("id"))`);
