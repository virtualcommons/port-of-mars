...
export class AddIncidentsTable1670976724329 implements MigrationInterface {
    name = 'AddIncidentsTable1670976724329'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TYPE "public"."incident_action_enum" AS ENUM('mute', 'ban')`);
        ...
        await queryRunner.query(`CREATE TABLE "incident" ("id" SERIAL NOT NULL, "reportId" integer NOT NULL, "userId" integer NOT NULL, "adminId" integer NOT NULL, "action" "public"."incident_action_enum" NOT NULL DEFAULT 'mute', "dateCreated" TIMESTAMP NOT NULL DEFAULT now(), "muteLength" integer, "dateExpires" TIMESTAMP GENERATED ALWAYS AS (case when "muteLength" is not null then "dateCreated" + interval '1 day' * "muteLength" else null end) STORED, "revoked" boolean NOT NULL DEFAULT false, CONSTRAINT "PK_5f90b28b0b8238d89ee8edcf96e" PRIMARY KEY ("id"))`);
