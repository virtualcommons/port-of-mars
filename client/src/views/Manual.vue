...
<template>
  ...
  <html lang="en">
    <head>
      ...
      <title>Port of Mars // Cheatsheet</title>
    </head>
    <body>
      <header style="grid-template-columns: 200px 1fr; position: static;">
        <img
          id="logo"
      ...
      <main>
        <section id="play" style="padding-top:200px;">
          <h2>Gameplay</h2>
          <div id="game-objectives">
            <section id="the-game">
              ...
              <p>
                ...
                purchasing, discarding, and reacting to Mars events. Chance and player actions
                impact system health. If system health falls to zero all players die.
              </p>
            </section>
            <section id="the-objectives">
              ...
              <p>
                ...
                receive 10 time blocks that you can invest in system health or accomplishments.
                System health will maintain the shared infrastructure (upkeep) and keep the team
                alive. Accomplishments will earn you victory points.
              </p>
            </section>
          </div>
          <section id="the-roles">
            <h3>The Roles</h3>
            <p>
              Roles (Port of Mars residents, AKA characters) will be assigned randomly as the game
              begins.
            </p>
            <section>
              <h4>Researcher</h4>
          ...
          <section id="the-phases">
            <h3>The Phases</h3>
            <p>
              A game consists of between 8 — 12 rounds and each round consists of the following
              phases.
            </p>
            <section>
              <h4>New Round</h4>
              <p>
                Each new round is a summary of what occurred in the previous round. It will show
                what accomplishment cards were purchased, player investments made, and Mars events
                that contributed to system health.
              </p>
            </section>
            <section>
              <h4>Mars Event</h4>
              <p>
                The “chance” card of the game. Players encounter a number of Mars events depending
                on system health level. They can positively or negatively impact players and the
                overall environment.
              </p>
            </section>
            <section>
          ...
          <section id="the-resources">
            <h3>The Resources</h3>
            <p>
              There are five different resource types in Port of Mars. These units can be acquired
              from Mars events, time blocks, are trades. Use them to purchase accomplishment cards
              which earns victory points.
            </p>
            <section>
              <h4>Science</h4>
              <img
          ...
          <section id="the-glossary">
            ...
            <section>
              <h4>Invite</h4>
              <p>
                Received by top players of surviving teams to play in the next round of the
                tournament
              </p>
            </section>
            <section>
            ...
            <section>
              <h4>Tournament</h4>
              <p>A contest. A series of elimination games to determine the winner.</p>
            </section>
            <section>
      ...
      <footer>
        ...
        <section id="social-media">
          ...
          <ul>
            <li>
              <a href="mailto:portofmars@asu.edu" title="email us"
                >Email
                <svg
                  xmlns="http://www.w3.org/2000/svg"
