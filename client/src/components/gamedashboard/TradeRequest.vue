<template>
  <div class="trade-request">
    ...
    <div class="trade-send-options">
      <TradeOptions :resourceReader="handleSendResources" text="You give up" class="options-block"/>
      <div class="options-block">
        <i class="fas fa-exchange-alt fa-2x"></i>
      </div>
      <TradeOptions :resourceReader="handleReciveResources" text="In exchange for" class="options-block"/>
    </div>
