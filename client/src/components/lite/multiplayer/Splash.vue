      ...
      <b-row class="mb-4">
        <b-col md class="px-4 d-flex flex-column text-center">
          ...
          <p v-if="currentSlide === 3">
            Your mission is to stay alive and achieve the most Points. In each round, you will normally
            receive 10 time-blocks that you can invest in System Health. System Health keeps your team alive.
            Time-blocks not invested in System Health earn you Points.
          </p>
        </b-col> 
      </b-row>
