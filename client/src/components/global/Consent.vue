    ...
    <b-collapse class="consent-scrollable" id="consent-collapse" :visible="showConsentForm">
      <div class="consent-form-text">
        ...
        <p>
          ...
          participate or to withdraw from the study at any time, there will be no penalty; it will
          not affect your compensation for participation up to that point.
        </p>
        <p>
        ...
        <p>
          ...
          decisions can help us to design policies and that sustain the use of shared resources, in
          this experiment in a habitat on Mars. You may benefit from this experience by learning
          about how an experiment is designed and conducted, what issues are of interest to social
          scientists and space research, and how make decisions in unanticipated situations.
        ...
        <p>
          ...
          nature of this study, complete confidentiality cannot be guaranteed. We delete all
          personal information such as your email address from our database after the study has been
          completed and ensure that only anonymized participant identifiers are associated with any
        ...
        <p class="text-muted">
          <small>
            ...
            (IRB). If the research team has not responded to your questions or concerns or if you
            are unable to establish contact with the research team you may contact the IRB by phone
            at 1.480.965.6788 or via email at
    ...
    <b-collapse v-if="!isVerified" class="consent-scrollable" v-model="consented">
      <b-form class="pr-3" @submit="register">
        <b-alert v-if="existingUser" dismissible show variant="warning">
          It looks like you have logged in before! Please review the information below, and resend
          your verification email if you have not received it yet. Sometimes email can take a few
          minutes to arrive in your inbox and you may need to check your spam folder as well.
        </b-alert>
        <b-alert v-else dismissible show variant="success"
          >Please fill out the fields below with your desired username and email so we can verify
          your email. Your full name is required if you wish to be eligible to win a gift card,
          however, we will never publish nor share this information.
        </b-alert>
        <b-form-group
        ...
        <b-button v-if="!hasConsented" :disabled="submitDisabled" type="submit" variant="success"
