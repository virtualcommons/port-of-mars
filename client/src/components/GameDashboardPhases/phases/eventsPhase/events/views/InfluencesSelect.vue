...
import DiscreteStatusBar from '@port-of-mars/client/components/GameDashboardPhases/phases/investmentPhase/DiscreteStatusBar.vue';
import CardInvestment from '@port-of-mars/client/components/GameDashboardPhases/phases/investmentPhase/CardInvestment.vue';
...
@import '@port-of-mars/client/stylesheets/GameDashboardPhases/phases/eventsPhase/events/views/InfluencesSelect.scss';
</style>
