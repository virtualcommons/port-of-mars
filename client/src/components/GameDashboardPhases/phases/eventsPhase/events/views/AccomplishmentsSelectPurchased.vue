...
import CardAccomplishment from '@port-of-mars/client/components/generalComponents/accomplishments/CardAccomplishment.vue';
...
@import '@port-of-mars/client/stylesheets/GameDashboardPhases/phases/eventsPhase/events/views/AccomplishmentsSelectPurchased.scss';
</style>
