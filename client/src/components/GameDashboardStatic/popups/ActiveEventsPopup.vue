...
import NewCardEvent from '@port-of-mars/client/components/GameDashboardPhases/phases/eventsPhase/NewCardEvent.vue';
...
@import '@port-of-mars/client/stylesheets/GameDashboardStatic/popups/ActiveEventsPopup.scss';
</style>
