...
import Player from './playerPanel/Player.vue';
import OtherPlayers from './playerPanel/OtherPlayers.vue';
import GameInformation from './informationPanel/GameInformation.vue';
import PhaseInstructions from './informationPanel/PhaseInstructions.vue';
...
@import '@port-of-mars/client/stylesheets/GameDashboardStatic/NewGameBoardTop.scss';
</style>
