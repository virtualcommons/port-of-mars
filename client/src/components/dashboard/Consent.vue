  ...
  <b-container class="h-100 m-0 p-0" fluid>
    <!-- <b-row no-gutters align-v="stretch" align-h="center" class="w-100 h-100"> -->
      <b-row class="w-100" align-v="center">
        <b-col cols="6" offset="3" class="p-3" style="background-color: var(--dark-shade-75)">
          <b-collapse id="consent-collapse" :visible="showConsentForm">
            <h2>Port of Mars Consent Form and Email Registration</h2>
            <div class="pr-2 my-3 consent-form-text">
              <p>Dear Participant,</p>
              <p>
                I am a professor in the School of Sustainability at Arizona State University. I am
                conducting experiments that investigate how people think, act, and make decisions.
                This research is part of the
                <a href="https://interplanetary.asu.edu/">Interplanetary Initiative</a> at Arizona
                State University.
              </p>
              <p>
                I am requesting your participation in a tournament consisting of several rounds of
                games. Each game in the tournament will take no more than 60 minutes on average. The
                top ranking players in each round will qualify for the next round and will receive
                an email invitation to participate in another game on a later day. Your
                participation in this study is strictly voluntary and you may choose to not
                participate or to withdraw from the study at any time with no penalty; it will not
                affect your compensation for participation up to that point.
              </p>
              <p>
                <mark
                  >You must be 18 or older and a current undergraduate student at Arizona State
                  University to participate in the study.</mark
                >
              </p>
              <p>
                During the game you can chat with other participants. By signing this consent form,
                you consent to:
              </p>
              <ul>
                <li>Abstain from personal attacks or harassment</li>
                <li>
                  Abstain from using profanity or offensive language when communicating with your
                  fellow participants
                </li>
              </ul>
              <p>
                For participation in this study you may receive extra credit if you are in a class
                with a participating instructor.
                <mark
                  >Those who qualify for the championship round will be invited to have lunch with
                  Arizona State University's astronaut in residence, Catherine Coleman. The
                  <em>winner</em> of the Mars Madness tournament will be eligible to create new
              ...
              <p>
                ...
                decisions can help us to design regulations that sustain the use of shared
                resources, in this experiment in a colony on Mars. You may benefit from this
                experience because you learn something about how an experiment is designed and
                conducted, what issues are of interest to social scientists and space research, and
                how your own cognitive abilities come into play in decision making situations. There
              ...
              <p>
                ...
                Your responses will be confidential. However, due to the group nature of this study,
                complete confidentiality cannot be guaranteed. If you are participating in this
                study as part of a class for extra credit, we may inform your instructor that you
                have participated, for example. We also have to keep track of which players will
                move on to next rounds. We will remove personal information such as your email
                address from our database after the tournament has been completed and ensure that
                only anonymized participant identifiers are associated with your experiment data.
              </p>
              <p>
          ...
          <b-button-group class="my-3">
            <b-button squared variant="success" @click="toggleConsent">{{ consentLabel }}</b-button>
            <b-button squared variant="danger" @click="denyConsent" class="mx-2"
              >Deny Consent</b-button
            >
          </b-button-group>
          <b-collapse v-model="consented">
            <b-form @submit="register">
              <b-alert v-if="existingUser" dismissible show variant="warning"
                >It looks like you have logged in before! Please review the information below, and
                resend your verification email if you have not received it yet. Sometimes email can
                take a few minutes to arrive in your inbox and you may need to check your spam
                folder as well.
              </b-alert>
              <b-alert v-else dismissible show variant="success"
                >Please fill out the fields below with your name and email so we can verify your
                email.
              </b-alert>
              <b-form-group
