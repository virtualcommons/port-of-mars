          ...
          <div class="title-wrapper">
            <div class="wrapper">
              ...
              <div class="filter-options">
                <input :value="0" @change="checked(0)" id="yourTrades" type="checkbox"
                       v-model="activeFilters">
                <label class="filter-option" for="yourTrades">Your Trades</label>
                <input :value="1" @change="checked(1)" id="requestedTrades" type="checkbox"
                       v-model="activeFilters">
                <label class="filter-option" for="requestedTrades">Trades Sent to You</label>
                <input :value="-1" @change="checked(-1)" id="allTrades" type="checkbox"
                       v-model="activeFilters">
