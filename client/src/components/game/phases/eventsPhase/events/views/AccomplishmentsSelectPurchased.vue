...
import CardAccomplishment from '@port-of-mars/client/components/reusables/accomplishments/CardAccomplishment.vue';
...
@import '@port-of-mars/client/stylesheets/game/phases/eventsPhase/events/views/AccomplishmentsSelectPurchased.scss';
</style>
