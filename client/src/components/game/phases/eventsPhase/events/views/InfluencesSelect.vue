...
import DiscreteStatusBar from '@port-of-mars/client/components/game/phases/investmentPhase/DiscreteStatusBar.vue';
import CardInvestment from '@port-of-mars/client/components/game/phases/investmentPhase/CardInvestment.vue';
...
@import '@port-of-mars/client/stylesheets/game/phases/eventsPhase/events/views/InfluencesSelect.scss';
</style>
