...
import NewGameBoardTop from '@port-of-mars/client/components/game/static/NewGameBoardTop.vue';
import NewGameBoardBottom from '@port-of-mars/client/components/game/phases/NewGameBoardBottom.vue';
...
import NewChat from '@port-of-mars/client/components/game/static/chat/NewChat.vue'
import NewSystemHealth from '@port-of-mars/client/components/game/static/systemHealth/NewSystemHealth.vue';
