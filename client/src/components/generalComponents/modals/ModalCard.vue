...
import ModalAccomplishment from './views/ModalAccomplishment.vue';
import ModalEvent from './views/ModalEvent.vue';
...
@import '@port-of-mars/client/stylesheets/generalComponents/modals/ModalCard.scss';
</style>
