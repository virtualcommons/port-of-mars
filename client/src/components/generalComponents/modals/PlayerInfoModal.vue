...
import InventoryTable from '@port-of-mars/client/components/generalComponents/InventoryTable.vue';
...
@import '@port-of-mars/client/stylesheets/generalComponents/modals/PlayerInfoModal.scss';
</style>