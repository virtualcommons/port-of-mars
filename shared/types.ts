...
export enum MarsLogCategory {
  systemHealth = "System Health",                       // reports increases, decreases, contirbuted upkeep
  event = "Event",                                      // reports event name and effect(s)
  purchaseAccomplishment = "Purchase Accomplishment",   // reports purchased accomplishment name, effect, and costs
  newTrade = "New Trade",                               // reports new trade from another player to you
  sentTrade = "Sent Trade",                             // reports sent trade from you to another player
  acceptTrade = "Accept Trade",                         // reports trade(s) accepted by you
  rejectTrade = "Reject Trade",                         // reports trade(s) rejected by you
  cancelTrade = "Cancel Trade"                          // reports trade(s) cancelled by you
